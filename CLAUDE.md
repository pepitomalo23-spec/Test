...
- Edge functions in `supabase/functions/` are deployed as-is; keep the repo copy identical to what is deployed. `callejero-sync` pins `jsr:@supabase/supabase-js@2.117.1` (the latest JSR release failed to bundle).
